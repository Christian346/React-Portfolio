...
export const TimeLineData = [
  { year: 2017, text: 'Started my career in Computer Science.', },
  { year: 2018, text: 'Began to focus in Front-end development.', },
  { year: 2019, text: 'Continued to expand my major to Computer Information Systems.', },
  { year: 2020, text: 'Got a bachelors in Computer Information Systems and And MCSA Web applications certification.', },
  { year: 2021, text: 'Continued to build multiple projects and practices in order to improve my skills.', },
  { year: 2023, text: 'Became a part of the Dominican Republic "Superate" government agency as a junior-web developer intern.', },
];